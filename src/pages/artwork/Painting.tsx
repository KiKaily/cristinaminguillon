  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-[4%] md:pt-[6%] container mx-auto px-4">
        <h1 className="text-4xl font-bold mb-8 mt-40 md:mt-0 handwriting-title">Ilustración</h1>
        <div className="space-y-8">
          <Card>
            <CardContent className="px-[2%] py-[4%] space-y-2">
            <h2 className="text-2xl font-semibold handwriting-title">ILUSTRACIONES</h2>
